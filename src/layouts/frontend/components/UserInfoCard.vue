    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <img class="w-15 h-15 mb-3 rounded-full shadow"
                src="https://img.quanxiaoha.com/quanxiaoha/f97361c0429d4bb1bc276ab835843065.jpg" alt="Bonnie image" />
            <!-- 博主昵称 -->
            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">way</h5>
            <!-- 介绍语 -->
            <span class="text-sm text-gray-500 dark:text-gray-400">你好Hello~</span>
            <!-- 第三方平台主页跳转（如 GitHub 等） -->
            <div class="flex justify-center gap-2">
                <!-- GitHub -->
                <svg t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                ...
                <!-- Gitee -->
                <svg t="1698030969736" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                ...
                <!-- 知乎 -->
                <svg t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon mt-5 w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
